...
{{--            <div class="col-md-2">--}}
{{--                <img src ="{{asset($categoryInfo -> category_image)}}" alt="" class="img-thumbnail img-fluid rounded-circle" style="">--}}
{{--            </div>--}}

            <div class="card card-body col-md-12 mt-2">
                <h4 class="text-center">{{ $categoryInfo-> category_name }} Books</h4>
            </div>
        </div>
    </section>
