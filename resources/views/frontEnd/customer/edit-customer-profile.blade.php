                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <input type="text" class="form-control" value=" {{ $customerInfo -> customer_name }}">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <input type="text" class="form-control" value=" {{ $customerInfo -> customer_email }}">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-9 text-secondary">
                                <input type="text" class="form-control" value="{{ $customerInfo -> customer_phone }}">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-sm-3">
