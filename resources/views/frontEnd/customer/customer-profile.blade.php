                                                ...
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        <table class="table align-middle mb-0">
                                                            <tbody>
                                                            @foreach($cartProducts as $enrollBook)
                                                            <tr>
                                                                <td>
                                                                    <div class="orderlist">
                                                                        <a class="d-flex align-items-center gap-2" href="javascript:;">
                                                                            <div class="product-box">
                                                                                <img src="{{ asset($enrollBook -> book_image) }}" class=" img-fluid" alt="">
                                                                            </div>
                                                                            <div>
                                                                                <P class="mb-0 product-title">{{ $enrollBook -> book_title }}</P>
                                                                            </div>
                                                                        </a>
                                                                    </div>
                                                                </td>
                                                                <td><a href="https://drive.google.com/file/d/17qJtNH-jG4ne0K17_sfj6CRsYmeao1_p/view?usp=sharing" class="btn btn-sm btn-outline-primary">Read Now</a></td>
                                                            </tr>
                                                            @endforeach
                                                            </tbody>
                                                        </table>
