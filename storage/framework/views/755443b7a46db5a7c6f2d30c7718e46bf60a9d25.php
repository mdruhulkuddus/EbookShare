    ...
    <nav class="navbar navbar-expand">
        ...
        <div class="top-navbar d-none d-xl-block">
            <ul class="navbar-nav align-items-center">
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('dashboard')); ?>" style="font-size: 20px; ">Admin Panel</a>
                </li>
                ...
                <li class="nav-item dropdown dropdown-large">
                    ...
                    <div class="dropdown-menu dropdown-menu-end p-0">
                        ...
                        <div class="header-message-list p-2">
                            ...
                            <a class="dropdown-item" href="#">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(asset('adminAsset')); ?>/assets/images/avatars/avatar-1.png" alt="" class="rounded-circle" width="52" height="52">
                            ...
                            <a class="dropdown-item" href="#">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(asset('adminAsset')); ?>/assets/images/avatars/avatar-2.png" alt="" class="rounded-circle" width="52" height="52">
                                    <div class="ms-3 flex-grow-1">
                            ...
                            <a class="dropdown-item" href="#">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(asset('adminAsset')); ?>/assets/images/avatars/avatar-3.png" alt="" class="rounded-circle" width="52" height="52">
                                    <div class="ms-3 flex-grow-1">
                            ...
                            <a class="dropdown-item" href="#">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(asset('adminAsset')); ?>/assets/images/avatars/avatar-4.png" alt="" class="rounded-circle" width="52" height="52">
                                    <div class="ms-3 flex-grow-1">
                            ...
                            <a class="dropdown-item" href="#">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(asset('adminAsset')); ?>/assets/images/avatars/avatar-5.png" alt="" class="rounded-circle" width="52" height="52">
                                    <div class="ms-3 flex-grow-1">
                            ...
                            <a class="dropdown-item" href="#">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(asset('adminAsset')); ?>/assets/images/avatars/avatar-6.png" alt="" class="rounded-circle" width="52" height="52">
                                    <div class="ms-3 flex-grow-1">
...
<?php /**PATH D:\SWE Training\xampp-BITM\htdocs\eBookShare\resources\views/admin/include/header.blade.php ENDPATH**/ ?>