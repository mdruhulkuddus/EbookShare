...
<?php $__env->startSection('content'); ?>
            ...
            <div class="col-md-12 border p-3 bg-white shadow-sm" style="border-radius: 3px;">
                <div class="row m-0">
                    <div class="col-md-4 left-side-product-box pb-3">
                        <img src ="<?php echo e(asset($productInfo -> book_image)); ?>" class="border p-3" style="height: 350px">
                    ...
                    <div class="col-md-8">
                        <div class="right-side-pro-detail border p-3 m-0">
                            <div class="row">
                                <div class="col-md-12">
                                    <h3 class="m-0 p-0 product-title"><?php echo e($productInfo -> book_title); ?></h3>
                                    <span>By</span> <a href=""><?php echo e($productInfo -> author_name); ?></a>
                                </div>
                                <div class="col-md-12">
                                    <hr class="opacity-25" >
                                    <div class="rating">
                                        ...
                                        <p class="tag-section"><strong>Category: </strong><a href=""><?php echo e($productInfo -> category_name); ?></a></p>
                                    </div>
                                </div>

                                <div class="col-md-12">
                                    <h3>Price : TK. <?php echo e($productInfo -> book_price); ?> </h3> <strike><?php echo e($productInfo -> book_price + 10); ?> TK</strike> <span>You Save TK. 4 (3%)</span>
                                    <hr class="opacity-25" >
                                </div>
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-summary" role="tabpanel" aria-labelledby="nav-summary-tab">
                        <div class="summary-content mt-3" >
                            <h5>Book- 	&apos;<?php echo e($productInfo -> book_title); ?>&apos;</h5>
                            <?php
                            ...
                            <p>
                                ...
                                <span id="moreText"> <?php echo $a; ?></span>
                            </p>
                    ...
                    <div class="tab-pane fade" id="nav-specification" role="tabpanel" aria-labelledby="nav-specification-tab">
                        <table class="table mt-3 table-bordered">
                            <tr>
                                ...
                                <td><?php echo e($productInfo -> book_title); ?></td>
                            </tr>
                            <tr>
                                <td style="background-color: #F1F2F4;  ">Author</td>
                                <td><?php echo e($productInfo -> author_name); ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($productInfo -> publisher_name); ?></td>
                            </tr>
                            <tr>
                                <td style="background-color: #F1F2F4;  ">Edition</td>
                                <td><?php echo e($productInfo -> edition); ?></td>
                            </tr>
                            <tr>
                                <td style="background-color: #F1F2F4;  ">Number of Pages</td>
                                <td><?php echo e($productInfo -> pages); ?></td>
                            </tr>
                            <tr>
                                <td style="background-color: #F1F2F4;  ">Language</td>
                                <td><?php echo e($productInfo -> language); ?></td>
                            </tr>
                    ...
                    <div class="tab-pane fade" id="nav-author" role="tabpanel" aria-labelledby="nav-author-tab">
                        <div class="row px-3 py-3">
                            <div class="col-md-2">
                                <img src ="<?php echo e(asset($productInfo -> author_image)); ?>" alt="" class="img-thumbnail img-fluid rounded-circle" style="">
                            </div>
                            <div class="col-md-10 mt-2">
                                <h4><?php echo e($productInfo-> author_name); ?></h4>
                                <?php
                                ...
                                ?>
                                <div class="">
                                    <p style=" text-align: justify; padding-right: 50px" class="reviewsUser"><?php echo e($productInfo -> author_biography); ?> </p>
    ...
    <section class="product-ebook p-0-135 ">
        <div class="row border c-mr-0 mt-3">
            ...
            <?php $__currentLoopData = $thisCategoryBooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="product-grid">
                        <div class="product-image">
                            <a href="<?php echo e(route('product-details', ['id' => $book->id ])); ?>" class="image">
                                <img src ="<?php echo e(asset($book->book_image)); ?>">
                            </a>
                            <ul class="product-links">
                                <li><a href="<?php echo e(route('product-details', ['id' => $book->id ])); ?>"><i class="fa fa-search"></i></a></li>
                        ...
                        <div class="product-content">
                            ...
                            <div class="price">৳<?php echo e($book -> book_price); ?> <span>৳<?php echo e($book -> book_price + 10); ?></span></div>
                        </div>
                    </div>
                </div>
    ...
    <section class="product-ebook p-0-135 ">
        <div class="row border c-mr-0 mt-3">
            ...
            <?php $__currentLoopData = $thisAuthorBooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                    $bookTitle = implode(' ', array_slice(explode(' ', $book->book_title), 0, 4));
                ?>
                <div class="col-md-3 col-sm-6">
    ...
    <section class="product-ebook p-0-135 ">
        <div class="row border c-mr-0 mt-3">
            ...
            <?php $__currentLoopData = $thisPublisherBooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                    $bookTitle = implode(' ', array_slice(explode(' ', $book->book_title), 0, 4));
                ?>
                <div class="col-md-3 col-sm-6">
...
<?php echo $__env->make('frontEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SWE Training\xampp-BITM\htdocs\eBookShare\resources\views/frontEnd/product/product-details.blade.php ENDPATH**/ ?>