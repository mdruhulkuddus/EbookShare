                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <?php echo e($customerInfo -> customer_email); ?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <?php echo e($customerInfo -> customer_phone); ?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <?php echo e($customerInfo -> address); ?>

                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <a class="btn btn-outline-primary" href="<?php echo e(route('edit-customer-profile', ['id' => $customerInfo -> id])); ?>">Edit</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                                                    ...
                                                                    <div class="orderlist">
                                                                        <a class="d-flex align-items-center gap-2" href="javascript:;">
                                                                            <div class="product-box">
                                                                                <img src="<?php echo e(asset('frontEndAsset/image/ebook1.jpg')); ?>" class=" img-fluid" alt="">
                                                                            </div>
                                                                            <div>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="orderlist">
                                                                        <a class="d-flex align-items-center gap-2" href="javascript:;">
                                                                            <div class="product-box">
                                                                                <img src="<?php echo e(asset('frontEndAsset/image/ebook4.jpg')); ?>" class=" img-fluid" alt="">
                                                                            </div>
                                                                            <div>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="orderlist">
                                                                        <a class="d-flex align-items-center gap-2" href="javascript:;">
                                                                            <div class="product-box">
                                                                                <img src="<?php echo e(asset('frontEndAsset/image/ebook2.jpg')); ?>" class=" img-fluid" alt="">
                                                                            </div>
                                                                            <div>
...
<?php echo $__env->make('frontEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SWE Training\xampp-BITM\htdocs\eBookShare\resources\views/frontEnd/customer/customer-profile.blade.php ENDPATH**/ ?>