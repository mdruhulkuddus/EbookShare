                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            ...
                            <h4 class="my-1">1.8K</h4>
                            <p class="mb-0 font-13 text-danger"><i class="bi bi-caret-down-fill"></i> 0.7 from last week</p>
                        </div>
        ...
        <div class="col">
            <div class="card radius-10">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            <p class="mb-0 text-secondary">Improve Rate</p>

                            <h4 class="my-1">18.15%</h4>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SWE Training\xampp-BITM\htdocs\eBookShare\resources\views/admin/home/home.blade.php ENDPATH**/ ?>