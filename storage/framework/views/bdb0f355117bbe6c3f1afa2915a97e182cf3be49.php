...
<?php $__env->startSection('content'); ?>
    <section class="author-books-header mt-3 p-0-135 ">
        <div class="row px-3 py-3 border bg-light c-mr-0">
            ...
            <div class="card card-body col-md-12 mt-2">
                <h4 class="text-center"><?php echo e($categoryInfo-> category_name); ?> Books</h4>
            </div>
        </div>
    </section>
    <section id="team" class="p-0-135 mt-2 author-books section-padding">
        <div class="row c-mr-0  bg-light pt-3">
            ...
            <?php $__currentLoopData = $categoryBooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
...
<?php echo $__env->make('frontEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SWE Training\xampp-BITM\htdocs\eBookShare\resources\views/frontEnd/category/category-books.blade.php ENDPATH**/ ?>