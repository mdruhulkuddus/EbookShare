...
<?php $__env->startSection('content'); ?>
    ...
    <section class="publisher-banner p-0-135 mt-5">
        <div class="row c-mr-0">
            <div class="col-md-12">
                <img src="<?php echo e(asset('frontEndAsset')); ?>/image/publisher/banner.jpg" style="width: 100%; height: 25vh">
            </div>
        </div>
    </section>
            ...
            <div class="col-md-3 mt-4 pt-2 mb-3">
                <div class="publishers position-relative d-block text-center">
                    <div class="image position-relative d-block overflow-hidden">
                        <?php if($publisher->publisher_image): ?>
                        <img src="<?php echo e(asset($publisher->publisher_image)); ?>" class="img-fluid rounded" alt="img">
                        <?php else: ?>
                        <img src="<?php echo e(asset('frontEndAsset/image/publisher/pb.jpg')); ?>" class="img-fluid rounded" alt="img">
                        <?php endif; ?>
                    ...
                    <div class="content py-2 member-position bg-white border-bottom overflow-hidden rounded d-inline-block shadow-sm">
                        <h4 class="title"><a href="<?php echo e(route('publisher-books', ['publisher_id' => $publisher->id])); ?>"><?php echo e($publisher->publisher_name); ?></a></h4>
                        <small class="text-muted"><i class="fa fa-book-open"></i>&nbsp; <?php echo e($productCountByPublisher); ?> books</small>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('frontEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SWE Training\xampp-BITM\htdocs\eBookShare\resources\views/frontEnd/publisher/publisher.blade.php ENDPATH**/ ?>