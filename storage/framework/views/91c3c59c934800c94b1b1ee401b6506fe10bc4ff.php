        ...
        <div class="row c-mr-0">
            ...
            <div class="col-md-9">
                <div class="row c-mr-0  bg-light pt-3">
                    ...
                    ?>
                    <?php $__currentLoopData = $featuresBook; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12 text-center" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
                            <div class="author-books-info bg-white">
                                <div class="team_img">
                                    <img src="<?php echo e(asset($book->book_image)); ?>" alt="book-image">
                                    <ul class="social">
...
<?php echo $__env->make('frontEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SWE Training\xampp-BITM\htdocs\eBookShare\resources\views/frontEnd/book/features-books.blade.php ENDPATH**/ ?>